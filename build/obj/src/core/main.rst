      ...
      000003 02 00 7F         [24]  355 	ljmp	_main
                                    ...
                                    360 	.area CSEG    (CODE)
                                    361 ;------------------------------------------------------------
                                    362 ;Allocation info for local variables in function 'delay_ms'
                                    363 ;------------------------------------------------------------
                                    364 ;ms                        Allocated to registers 
                                    365 ;t                         Allocated to registers r4 r5 
                                    366 ;------------------------------------------------------------
                                    367 ;	src/core/main.c:3: void delay_ms(unsigned int ms) {
                                    368 ;	-----------------------------------------
                                    369 ;	 function delay_ms
                                    370 ;	-----------------------------------------
      000062                        371 _delay_ms:
                           000007   372 	ar7 = 0x07
                           000006   373 	ar6 = 0x06
                           000005   374 	ar5 = 0x05
                           000004   375 	ar4 = 0x04
                           ...
                           000001   378 	ar1 = 0x01
                           000000   379 	ar0 = 0x00
      000062 AE 82            [24]  380 	mov	r6, dpl
      000064 AF 83            [24]  381 	mov	r7, dph
      000066                        382 00107$:
                                    383 ;	src/core/main.c:4: for(;--ms;)
      000066 1E               [12]  384 	dec	r6
      000067 BE FF 01         [24]  385 	cjne	r6,#0xff,00137$
      00006A 1F               [12]  386 	dec	r7
      00006B                        387 00137$:
      00006B EE               [12]  388 	mov	a,r6
      00006C 4F               [12]  389 	orl	a,r7
      00006D 60 0F            [24]  390 	jz	00109$
                                    391 ;	src/core/main.c:5: for(unsigned int t=114;--t;)
      00006F 7C 72            [12]  392 	mov	r4,#0x72
      000071 7D 00            [12]  393 	mov	r5,#0x00
      000073                        394 00104$:
      000073 1C               [12]  395 	dec	r4
      000074 BC FF 01         [24]  396 	cjne	r4,#0xff,00139$
      000077 1D               [12]  397 	dec	r5
      000078                        398 00139$:
      000078 EC               [12]  399 	mov	a,r4
      000079 4D               [12]  400 	orl	a,r5
      00007A 70 F7            [24]  401 	jnz	00104$
      00007C 80 E8            [24]  402 	sjmp	00107$
      00007E                        403 00109$:
                                    404 ;	src/core/main.c:7: }
      00007E 22               [24]  405 	ret
                                    406 ;------------------------------------------------------------
                                    407 ;Allocation info for local variables in function 'main'
                                    408 ;------------------------------------------------------------
                                    409 ;	src/core/main.c:9: void main(void) {
                                    410 ;	-----------------------------------------
                                    411 ;	 function main
                                    412 ;	-----------------------------------------
      00007F                        413 _main:
      00007F                        414 00102$:
                                    415 ;	src/core/main.c:12: P1 = 0x00;
      00007F 75 90 00         [24]  416 	mov	_P1,#0x00
                                    417 ;	src/core/main.c:13: delay_ms(500);
      000082 90 01 F4         [24]  418 	mov	dptr,#0x01f4
      000085 12 00 62         [24]  419 	lcall	_delay_ms
                                    420 ;	src/core/main.c:14: P1 = 0xff;
      000088 75 90 FF         [24]  421 	mov	_P1,#0xff
                                    422 ;	src/core/main.c:15: delay_ms(500);
      00008B 90 01 F4         [24]  423 	mov	dptr,#0x01f4
      00008E 12 00 62         [24]  424 	lcall	_delay_ms
                                    425 ;	src/core/main.c:17: }
      000091 80 EC            [24]  426 	sjmp	00102$
                                    427 	.area CSEG    (CODE)
                                    428 	.area CONST   (CODE)
                                    429 	.area XINIT   (CODE)
